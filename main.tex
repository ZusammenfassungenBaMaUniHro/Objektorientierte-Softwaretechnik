...
\tableofcontents
	\section{Grundbegriffe}
		\begin{description}
			...
			\item[Vererbung:] Weiterleitung von Informationen von oben nach unten, Unterklasse erbt Attribute, Methoden und Assoziationen oder Oberklasse, Wiederverwendung (spezialisieren $\rightarrow$ überschreiben, erweitern$\rightarrow$ hinzufügen)
			...
			\item[Verhalten:] Methoden $\rightarrow$ Sequenzdiagramm
			...
			\item[Substitutionsprinzip:] Ein Objekt einer Unterklasse kann die Rolle eines Objektes entsprechenden Oberklasse übernehmen - nur möglich, wenn es sich wie das der Oberklasse verhält.
